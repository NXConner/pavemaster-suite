...
import { 
  ...
  Lock, Key, Fingerprint, Scan, Search, Filter, SortAsc,
  Play, Pause, CircleStop, SkipForward, SkipBack, Volume2,
  Maximize, Minimize, RotateCcw, RefreshCw, Download, Upload,
  Settings, Cog, Wrench, PenTool, Hammer, Settings as ToolIcon,
  Calendar, Clock, Timer, Watch, AlarmClock,
